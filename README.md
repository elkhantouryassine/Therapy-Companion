...
A self-contained therapy companion web app for private accounts, check-ins, journaling, grounding, reframing, breathing, local agent support, and safety planning.
